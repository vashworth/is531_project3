"""
Django settings for is531_project3 project.
...
ALLOWED_HOSTS = ['is531-project3-dev.us-west-2.elasticbeanstalk.com']
...
ROOT_URLCONF = 'is531_project3.urls'
...
WSGI_APPLICATION = 'is531_project3.wsgi.application'
